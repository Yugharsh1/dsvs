...
# Create all the labels required to be 
label_id = Label(root)
...
def license(): 
    ...
    pin=283911
    print(type(pin))
    address="22 Waterwoods, Ramagondanhalli"
    print(type(address))
...
# Create a button
button1=Button(root, text="Show driving license", command=license)
